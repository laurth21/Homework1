...
The first one [ruff.yml](.github/workflows/ruff.yml) ensures that new added files and updated files pushed to this repository meet the coding style. The second one [run_test_on_GitHub.yml](.github/workflows/run_test_on_GitHub.yml) runs the test of the functions on GitHub. 
